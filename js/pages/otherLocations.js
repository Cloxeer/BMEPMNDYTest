/**
 * @file js/pages/otherLocations.js
 * @summary The Other Locations page: every NMSU property where classes happen, nearest first.
 *
 ...
 *                These are NMSU's properties (whole campuses and sites), not places
 *                the map leads you to: those are on the Locations page (./locations.js).
...
export class OtherLocationsPage {
  /**
